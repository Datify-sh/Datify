...
#[openapi(
    ...
    paths(
        ...
        crate::api::handlers::get_database_config,
        crate::api::handlers::update_database_config,
    ...
    components(schemas(
        ...
        crate::domain::models::DatabaseConfigResponse,
        crate::domain::models::UpdateDatabaseConfigRequest,
        crate::domain::models::UpdateDatabaseConfigResponse,
        crate::domain::models::ConfigFormat,
        crate::domain::models::ConfigSource,
    ...
    tags(
        ...
        (name = "Config", description = "Database configuration endpoints"),
